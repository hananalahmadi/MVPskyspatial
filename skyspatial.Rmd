...
```{r, echo = FALSE}
knitr::include_graphics("~/Downloads/5.Summer2024/SKYSPATIAL/skyspatial/yfx.png")
```
...
This website has a [shiny app](https://ul7mk9-lenin0rafael-riera0segura.shinyapps.io/appdir/)
